internal class Program
{
    ...
    {
        string name = "Mpendulo \"";
        string another = "Mpendulo \n \t";
        string verbatum = @"Mpendulo \n";

        string literal = """
                         This is basically Python now!!!
                         """;
        string interpolation = $"Hello, {name}!"; // just like in JS 
        string empty = String.Empty; // instead of ""
